...
namespace Accounting.Pages
{
    public partial class AddSupplierComponent : ComponentBase
    {
        ...
        {
            supplier = new Accounting.Models.AccountingDb.Supplier(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Accounting.Models.AccountingDb.Supplier args)
        {
            try
            {
                var accountingDbCreateSupplierResult = await AccountingDb.CreateSupplier(supplier);
                DialogService.Close(supplier);
            }
            catch (System.Exception accountingDbCreateSupplierException)
            {
